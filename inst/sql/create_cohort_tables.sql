...
-- add example cohort definitions
...
(
  select concept_id from @cdm_schema.CONCEPT where concept_id in (4097216,4120570,4113618,4236738,4245036,4055374,45767337,4165535,40486624,3022875,21490855)
...
DELETE FROM @cdm_results_schema.cohort where cohort_definition_id = 1;
INSERT INTO @cdm_results_schema.cohort (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
