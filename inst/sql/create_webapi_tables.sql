...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_inclusion (cohort_definition_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_inclusion_result (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.heracles_analysis
 (analysis_id int,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.heracles_results
 (cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
--HINT BUCKET(analysis_id, 64)
CREATE TABLE IF NOT EXISTS @cdm_results_schema.heracles_results_dist
 (cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
	stratum_2 varchar(255),
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.heracles_periods
 (period_id int,
  period_order int,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.cohort_sample_element (cohort_sample_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);

CREATE TABLE IF NOT EXISTS @cdm_results_schema.cc_results
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.pathway_analysis_codes
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.pathway_analysis_events
 (pathway_analysis_generation_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.pathway_analysis_paths
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
  step_2 BIGINT,
...
CREATE TABLE IF NOT EXISTS @cdm_results_schema.pathway_analysis_stats
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
/*********************************************************************/
CREATE TABLE IF NOT EXISTS @cdm_results_schema.concept_hierarchy
 (concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE @cdm_results_schema.concept_hierarchy;

/********** CONDITION/CONDITION_ERA **********/
INSERT INTO @cdm_results_schema.concept_hierarchy
...
LEFT JOIN (
	...
	INNER JOIN @cdm_schema.concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN @cdm_schema.concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN @cdm_schema.concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN @cdm_schema.concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
LEFT JOIN @cdm_schema.concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN @cdm_schema.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN @cdm_schema.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN @cdm_schema.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN @cdm_schema.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN @cdm_schema.concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN @cdm_schema.concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN @cdm_schema.concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN @cdm_schema.concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN @cdm_schema.concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN @cdm_schema.concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM @cdm_schema.concept c1
	INNER JOIN @cdm_schema.vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM @cdm_schema.concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM @cdm_schema.concept_ancestor ca1
		INNER JOIN @cdm_schema.concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
		INNER JOIN @cdm_schema.concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
		INNER JOIN @cdm_schema.concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
...
TRUNCATE TABLE @cdm_results_schema.heracles_analysis;

insert into @cdm_results_schema.heracles_analysis
...
TRUNCATE TABLE @cdm_results_schema.heracles_periods;

INSERT INTO @cdm_results_schema.heracles_periods (period_id, period_name, period_order, period_type, period_start_date, period_end_date)
